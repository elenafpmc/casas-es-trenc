...
return[
    ...
    'DATOS_DE_INSCRIPCION'     => 'Datos de inscripción en el Registro Mercantil de Palma de Mallorca: Tomo 2119, Libro 0, Folio 82, Inscripción 9, Hoja PM-50.035.',
    'CONTACTO'                 => 'Contacto:',
    'DIRECCION_DE_CORREO_E'    => 'Dirección de correo electrónico:',
    'TELEFONO'                 => 'Teléfono:',
    'EN_CUALQUIER_MOMENTO'     => 'En cualquier momento, el interesado podrá guardar o imprimir este Aviso Legal.',
    'LA_UTILIZACION_DE_ESTA'   => 'La utilización de esta página Web atribuye la condición de usuario a quien lo haga e implica la aceptación de todas las condiciones incluidas en este Aviso Legal.',
    'TODOS_LOS_CONTENIDOS'     => 'Todos los contenidos de esta Web (textos, fotografías, gráficos, imágenes, tecnología, software, links, contenidos audiovisuales, diseño gráfico, código fuente, etc.), así como las marcas y demás signos distintivos, son propiedad de URNOVA, no adquiriendo el usuario ningún derecho sobre ellos por el mero uso de esta Web.',
    'QUEDA_PROHIBIDO'          => 'Queda prohibido cualquier uso de esta Web que tenga como finalidad o produzca como resultado la lesión de bienes, derechos o intereses de URNOVA, del resto de las empresas del Grupo, de sus clientes, proveedores o de terceros. Queda igualmente prohibido realizar cualquier uso de esta Web que altere, dañe o inutilice las redes, servidores, equipos, productos y programas informáticos de URNOVA.',
